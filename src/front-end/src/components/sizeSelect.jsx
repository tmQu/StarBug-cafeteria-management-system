...
const SizeSelect = () => {
    ...
    const renderSizeButton = (size, price) => {
        ...
        return (
            ...
            >
                <svg className={`w-[24px] h-[24px] ${isSelected ? 'text-blue-500' : 'text-gray-400'}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="Radio Button">
                        <circle id="Ellipse_2" cx="12" cy="12" r="11" fill="white" stroke={isSelected ? '#2D68FE' : '#C2C1C1'} strokeWidth="2" />
                        {isSelected && <circle id="Ellipse_3" cx="12" cy="12" r="6" fill="#2D68FE" />}
                    </g>
                </svg>
                <div className="ml-4">
                    <p>{size}</p>
