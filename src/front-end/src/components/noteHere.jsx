...
const NoteHere = () => {
    ...
    return (
        <div className={`w-[400px] h-[53px] flex border-[1px] rounded-[5px] overflow-hidden ${isFocused ? 'border-[blue]' : 'border-[#D9D9D9]'} hover:shadow-md shadow-none`}>
            ...
            <div className="h-[52px] flex-grow relative">
                <input
                    className="w-[348px] h-[52px] px-4 bg-transparent text-[16px] font-Source-Sans-3 font-normal outline-none"
