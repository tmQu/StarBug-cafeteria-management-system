    ...
    return (
        <div className="w-[305px] h-[330px] flex flex-col bg-[#F4F2EC] px-[8px] py-[10px] rounded-[8px]">
            ...
            <div className="h-[60px] flex flex-row py-[15px] gap-[12px] items-center my-0 hover:bg-[#DEDAD0] hover:rounded-[14px]">
                <div className="pl-[14px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        <path d="M14.8438 16.25C14.4986 16.25 14.2188 16.5298 14.2188 16.875V18.4375H1.71875V1.5625H14.2188V1.875C14.2188 2.22015 14.4986 2.5 14.8438 2.5C15.1889 2.5 15.4688 2.22015 15.4688 1.875V0.9375C15.4688 0.592346 15.1889 0.3125 14.8438 0.3125H1.09375C0.748596 0.3125 0.46875 0.592346 0.46875 0.9375V19.0625C0.46875 19.4077 0.748596 19.6875 1.09375 19.6875H14.8438C15.1889 19.6875 15.4688 19.4077 15.4688 19.0625V16.875C15.4688 16.5298 15.1889 16.25 14.8438 16.25Z" fill="#0E3746" />
                        <path d="M13.5938 3.4375C10.3198 3.4375 7.65625 6.10107 7.65625 9.375C7.65625 12.6489 10.3198 15.3125 13.5938 15.3125C16.8677 15.3125 19.5312 12.6489 19.5312 9.375C19.5312 6.10107 16.8677 3.4375 13.5938 3.4375ZM13.5938 14.0625C11.0089 14.0625 8.90625 11.9597 8.90625 9.375C8.90625 6.79031 11.0089 4.6875 13.5938 4.6875C16.1786 4.6875 18.2812 6.79031 18.2812 9.375C18.2812 11.9597 16.1786 14.0625 13.5938 14.0625Z" fill="#0E3746" />
                        <path d="M14.4211 9.26087L15.3638 7.84668C15.5552 7.55951 15.4777 7.17148 15.1905 6.97998C14.903 6.78787 14.5151 6.866 14.3238 7.15332L13.0738 9.02832C12.8983 9.29138 12.9471 9.64386 13.187 9.84955L15.3745 11.7245C15.4923 11.8256 15.637 11.875 15.781 11.875C15.9571 11.875 16.1323 11.801 16.2559 11.6568C16.4805 11.3947 16.4503 11.0001 16.1881 10.7755L14.4211 9.26087Z" fill="#0E3746" />
                        <path d="M3.59375 6.875H5.78125C6.1264 6.875 6.40625 6.59515 6.40625 6.25C6.40625 5.90485 6.1264 5.625 5.78125 5.625H3.59375C3.2486 5.625 2.96875 5.90485 2.96875 6.25C2.96875 6.59515 3.2486 6.875 3.59375 6.875Z" fill="#0E3746" />
                        <path d="M3.59375 9.375H4.53125C4.8764 9.375 5.15625 9.09515 5.15625 8.75C5.15625 8.40485 4.8764 8.125 4.53125 8.125H3.59375C3.2486 8.125 2.96875 8.40485 2.96875 8.75C2.96875 9.09515 3.2486 9.375 3.59375 9.375Z" fill="#0E3746" />
                        <path d="M3.59375 11.875H5.15625C5.5014 11.875 5.78125 11.5952 5.78125 11.25C5.78125 10.9048 5.5014 10.625 5.15625 10.625H3.59375C3.2486 10.625 2.96875 10.9048 2.96875 11.25C2.96875 11.5952 3.2486 11.875 3.59375 11.875Z" fill="#0E3746" />
                        <path d="M3.59375 14.375H7.34375C7.6889 14.375 7.96875 14.0952 7.96875 13.75C7.96875 13.4048 7.6889 13.125 7.34375 13.125H3.59375C3.2486 13.125 2.96875 13.4048 2.96875 13.75C2.96875 14.0952 3.2486 14.375 3.59375 14.375Z" fill="#0E3746" />
                    </svg>
                </div>
                <div className="text-[#0E3746] font-medium text-[20px]">
                    Order History
