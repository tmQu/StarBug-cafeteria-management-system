            ...
            <div className="h-[60px] flex flex-row py-[15px] gap-[12px] items-center my-0">
                <div className="pl-[14px]">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M15.1565 5.88477H5.7002V6.91357H15.1565V5.88477Z" fill="#0E3746" />
                        <path d="M15.1565 12.8395H5.7002V13.8683H15.1565V12.8395Z" fill="#0E3746" />
                        <path d="M3.06425 0.0411524L2.99835 0.123457L0 3.86831L0.329489 4.27984L0.362438 4.32099L0.428336 4.40329L0.494234 4.4856L2.76771 1.60494V14.4033H3.22899H3.29489H3.36079H3.45964V1.60494L5.73311 4.4856L5.89786 4.27984L6.0626 4.07407L6.09555 4.03292L6.16145 3.95062L6.22735 3.86831L3.13015 0L3.06425 0.0411524Z" fill="#0E3746" />
                        <path d="M19.868 15.9259L19.8351 15.8848L19.6703 15.7201L19.5715 15.5555L19.5385 15.5144L17.2321 18.3539V5.55554H17.0674H17.0015H16.639H16.5402V18.3539L14.2667 15.5144L14.1349 15.6378L14.102 15.7201L13.7725 16.0905L16.7708 19.8354L16.8367 19.9177L16.9026 20L16.9685 19.9177L19.9998 16.0905L19.868 15.9259Z" fill="#0E3746" />
                    </svg>
                </div>
                <div className="text-[#0E3746] font-medium text-[20px]">
                    Order Manager
            ...
            <div className="h-[60px] flex flex-row py-[15px] gap-[12px] items-center my-0 border-b-[0.7px] border-solid border-[#CECECE]">
                <div className="pl-[14px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <circle cx="9.9998" cy="16.7" r="0.6" stroke="#0E3746" stroke-width="1.2" />
                    </svg>
                </div>
                <div className="text-[#0E3746] font-medium text-[20px]">
                    Help Center
            ...
            <div className="h-[70px] flex flex-row gap-[14px] py-[16px] items-center">
                <div className="pl-[14px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                        ...
                        <path d="M10 6.5V5.5C10 4.11929 11.1193 3 12.5 3H14.5C15.8807 3 17 4.11929 17 5.5V14.5C17 15.8807 15.8807 17 14.5 17H12.5C11.1193 17 10 15.8807 10 14.5V14" stroke="#0E3746" stroke-width="1.5" stroke-linecap="round" />
                    </svg>
                </div>
                <div className="text-[#0E3746] font-medium text-[20px]">
                    Sign Out
