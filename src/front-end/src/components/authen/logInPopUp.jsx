...
const SignInPopUp = () => {
  ...
  const { isOpenForgotPasswordPopUp, isOpenSignUpPopUp } = useSelector((state) => state.popUpReducer);
  ...
  useEffect(() => {
    const mouseDownHandler = (e) => {
      if (
        ...
        PopUpRef.current &&
        PopUpRef.current.contains && // Kiểm tra xem PopUpRef.current tồn tại và có contains không
        !PopUpRef.current.contains(e.target)
      ) {
        handleForgotButton(false);
      }
    };
                  ...
                  (
                    <div className="w-[380px] h-fit py-4 pt-6 flex flex-col justify-center items-center rounded-[10px] bg-[#F4F2EC] shadow-xl mx-auto gap-[20px]">
                      ...
                      <div className="w-[300px] flex flex-row">
                        ...
                        <button onClick={handleForgotButton}
