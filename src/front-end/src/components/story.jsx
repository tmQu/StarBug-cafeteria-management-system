const Story = ({reverse='false', image, title, subtitle, paragraph}) => {
  ...
  return (
    <div className={`w-[960px] h-full flex justify-center gap-14 mx-auto py-2 ${reverse ? "flex-row-reverse ":"flex-row"}`}>
      <div className="w-[400px] h-[460px] text-[#0D3745] flex flex-col justify-center">
        <p className="text-2xl font-bold">{title}</p>
        <p className="max-w-[400px] text-7xl font-bold">{subtitle}</p>
