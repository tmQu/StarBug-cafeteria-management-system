        ...
        <div className="flex w-[255px] h-[45px] ml-auto justify-between">
          <a className="transition-transform duration-500 ease-in-out cursor-pointer hover:scale-[1.1]">
            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45" fill="none">
              ...
              <path d="M19.0938 20.5H16.2812C16.126 20.5 16 20.626 16 20.7812V29.2188C16 29.374 16.126 29.5 16.2812 29.5H19.0938C19.249 29.5 19.375 29.374 19.375 29.2188V20.7812C19.375 20.626 19.249 20.5 19.0938 20.5Z" fill="#183942" />
          ...
          <a className="transition-transform duration-500 ease-in-out cursor-pointer hover:scale-[1.1]">
            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45" fill="none">
              <path opacity="0.25" d="M44 22.5C44 34.3741 34.3741 44 22.5 44C10.6259 44 1 34.3741 1 22.5C1 10.6259 10.6259 1 22.5 1C34.3741 1 44 10.6259 44 22.5Z" stroke="#183942" stroke-width="2" />
              <path d="M20.699 29.393L20.6786 23.0961H18V20.3974H20.6786V18.5983C20.6786 16.1702 22.171 15 24.3209 15C25.3507 15 26.2358 15.0772 26.4937 15.1118V17.6493L25.0026 17.65C23.8334 17.65 23.607 18.2097 23.607 19.0312V20.3974H26.9286L26.0357 23.0961H23.607V29.393H20.699Z" fill="#183942" />
            </svg>
          </a>
          <a className="transition-transform duration-500 ease-in-out cursor-pointer hover:scale-[1.1]">
            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45" fill="none">
              <path opacity="0.25" d="M44 22.5C44 34.3741 34.3741 44 22.5 44C10.6259 44 1 34.3741 1 22.5C1 10.6259 10.6259 1 22.5 1C34.3741 1 44 10.6259 44 22.5Z" stroke="#183942" stroke-width="2" />
              <path d="M25.8678 19.9422C26.2986 19.9422 26.6478 19.593 26.6478 19.1622C26.6478 18.7314 26.2986 18.3822 25.8678 18.3822C25.437 18.3822 25.0878 18.7314 25.0878 19.1622C25.0878 19.593 25.437 19.9422 25.8678 19.9422Z" fill="#183942" />
              <path fill-rule="evenodd" clip-rule="evenodd" d="M19.25 22.5C19.25 24.2924 20.7076 25.75 22.5 25.75C24.2924 25.75 25.75 24.2924 25.75 22.5C25.75 20.7076 24.2924 19.25 22.5 19.25C20.7076 19.25 19.25 20.7076 19.25 22.5ZM20.875 22.5C20.875 21.6038 21.6038 20.875 22.5 20.875C23.3962 20.875 24.125 21.6038 24.125 22.5C24.125 23.3962 23.3962 24.125 22.5 24.125C21.6038 24.125 20.875 23.3962 20.875 22.5Z" fill="#183942" />
              <path fill-rule="evenodd" clip-rule="evenodd" d="M19.25 29H25.75C27.4205 29 29 27.4205 29 25.75V19.25C29 17.5795 27.4205 16 25.75 16H19.25C17.5795 16 16 17.5795 16 19.25V25.75C16 27.4205 17.5795 29 19.25 29ZM17.625 19.25C17.625 18.4903 18.4903 17.625 19.25 17.625H25.75C26.5097 17.625 27.375 18.4903 27.375 19.25V25.75C27.375 26.5097 26.5097 27.375 25.75 27.375H19.25C18.4757 27.375 17.625 26.5243 17.625 25.75V19.25Z" fill="#183942" />
            </svg>
          </a>
          <a className="transition-transform duration-500 ease-in-out cursor-pointer hover:scale-[1.1]">
            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45" fill="none">
              <path opacity="0.25" d="M44 22.5C44 34.3741 34.3741 44 22.5 44C10.6259 44 1 34.3741 1 22.5C1 10.6259 10.6259 1 22.5 1C34.3741 1 44 10.6259 44 22.5Z" stroke="#183942" stroke-width="2" />
              <path fill-rule="evenodd" clip-rule="evenodd" d="M29.2659 17.3431C29.951 17.5244 30.4906 18.0559 30.6745 18.7295C31.0159 19.9588 30.9999 22.522 30.9999 22.522C30.9999 22.522 30.9975 25.071 30.6665 26.2996C30.4803 26.9724 29.9382 27.5031 29.2539 27.6836C28.002 28.0055 22.9935 28 22.9935 28C22.9935 28 17.9987 27.9945 16.734 27.6569C16.0481 27.4756 15.5084 26.9441 15.3246 26.2713C14.9968 25.0545 15 22.4921 15 22.4921C15 22.4921 15.0032 19.9423 15.3334 18.713C15.5188 18.0402 16.0736 17.4969 16.7452 17.3172C17.9979 16.9945 23.0055 17 23.0055 17C23.0055 17 28.014 17.0055 29.2659 17.3431ZM21.4075 20.1441L21.4035 24.8543L25.5701 22.5031L21.4075 20.1441Z" fill="#183942" />
            </svg>
          </a>
        </div>
      </div>
