...
const rows = staff && Array.isArray(staff) ? staff.map((item) => ({
  ...
  return (
    <div className="w-screen h-fit mx-auto">
      <div className="w-screen mx-auto flex flex-col gap-4 bg-[#F4F2EC] bg-[url('../../public/assets/background.svg')]">
        <div>
          <ManagementTable columns={columns} rows={rows} tableName="STAFF MANAGEMENT" />
        </div>
      </div>
    </div >
  );
